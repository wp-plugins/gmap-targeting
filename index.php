...
/*
  ...
  Description: Set Google Map everywhere on your site simply, one click - one map
    ...
    public static function admin_head() {
        ...
        if ($show_shortcode):
            ...
            <script type="text/javascript">
                var pn_ext_shortcodes3_app_link = "<?php echo PluginusNet_GMapTargeting::get_application_uri() ?>";
            ...
            ?>
                ...
                var pn_ext_shortcodes3_lang2 = "<?php _e('Insert Google Map', 'gmap-targeting') ?>";
...
class PluginusNet_GmapTargetingWidget extends WP_Widget {
    ...
    function __construct() {
        ...
        //Creation
        $this->WP_Widget(__CLASS__, __('PluginUs.Net Google Map', 'gmap-targeting'), $settings);
    }
